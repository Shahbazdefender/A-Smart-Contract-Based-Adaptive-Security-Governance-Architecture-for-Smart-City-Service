...
do
echo "Shahbaz"
openssl genrsa -out private-key$i.pem 3072 > /home/ubuntu/Desktop/Shahbaz_Final_Project/Ada-Framework-Shahbaz1/01-GetStarted/Keys/Keys2/keto$i.key

openssl rsa -in private-key$i.pem -pubout -out public-key$i.pem
