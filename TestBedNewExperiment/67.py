...
# time.sleep(0.015)# for 15ms  3000 
        ...
        str_file='/home/ubuntu/Desktop/Shahbaz_Final_Project/TestBedNewExperiment/1.txt'
        f=open(str_file,"a")
...
# time.sleep(0.015)# for 15ms  3000 
        ...
        recieve_time_seconds = time.time()
        tuple_ind2 = (str(current_time), str(recieve_time), str(((recieve_time_seconds - current_time_seconds))))
        str_file='/home/ubuntu/Desktop/Shahbaz_Final_Project/TestBedNewExperiment/2.txt'
        f=open(str_file,"a")
        f.write(str(tuple_ind2)+'\n')
        print("End of 2---------------------------------------------------------------")
...
# time.sleep(0.015)# for 15ms  3000 
        ...
        recieve_time_seconds = time.time()
        tuple_ind2 = (str(current_time), str(recieve_time), str(((recieve_time_seconds - current_time_seconds))))
        str_file='/home/ubuntu/Desktop/Shahbaz_Final_Project/TestBedNewExperiment/3.txt'
        f=open(str_file,"a")
        f.write(str(tuple_ind2)+'\n')
        print("End of 3---------------------------------------------------------------")
...
#print(result1[0]['txid'])
    ...
    ##GlobalContext Increase   
      ...
      ##GlobalPolicy Increase   
        ...
        list3b.append(((recieve_time_seconds - current_time_seconds)))
        tuple_ind2 = (str(current_time), str(recieve_time), str(((recieve_time_seconds - current_time_seconds))))
        str_file='/home/ubuntu/Desktop/Shahbaz_Final_Project/TestBedNewExperiment/00.txt'
        f=open(str_file,"a")
        f.write(str(tuple_ind2)+'\n')
